...
namespace PutridParrot.Maui.Collections.Helpers;
...
public static class ListExtensions
{
    ...
    {
        return list.BinarySearch(0, list.Count - 1, searchItem, matcher);
    }
    ...
    {
        return list.BinarySearchInsertionPoint(0, list.Count - 1, searchItem, matcher);
    }
    ...
    {
        return list.BinarySearch(0, list.Count - 1, item, matcher);
    }
